...
【MAINのフック型（テーマに合うものを1つ選ぶ）】
・権威フレーム型（最優先・このアカウントで最も伸びる勝ちパターン。テーマが許すなら積極的に使う）「健診で『体重を落としましょう』と言われた50代の方へ。」のように健診・医師など“外からの指摘”を起点にし、「最初にやるべきは食事制限ではなく〇〇かもしれません」と答えを一つだけ保留して続きを想起させる
・比較型「痩せる人・太る人、違いは〇〇でした。」
・意外性型「食べる量より〇〇の方が体重に響くことがあります。」
・共感型「〜してるのに痩せない方へ。」
