...
`
  ...
  const ctaOptions = [
    "自分に向いた進め方を知りたい方へ。無料の「ダイエットタイプ診断」（約1分）をプロフィールのリンクからどうぞ。",
    "何から始めればいいか迷う方へ。無料診断で「あなたに向いた一歩」が見つかります。プロフィールのリンクから。",
    "まずは無料の体質タイプ診断から。結果に合わせてLINEで相談もできます。プロフィールのリンクへ。",
    "「私には何が足りない？」は無料診断でチェックできます。プロフィールのリンクから試してみてください。",
  ]
